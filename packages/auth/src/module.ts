 ...
 * the kernel and already imports `@app/auth/module`, calls this once:
 *
 * ```ts
 * import { module as authModule, acceptHotUpdate } from '@app/auth/module';
...
export function acceptHotUpdate(kernel: Kernel, hot?: ModuleHotContext): void {
  ...
  context.accept((next) => {
    ...
    void kernel.hotReplace(AuthModule, replacement.module);
